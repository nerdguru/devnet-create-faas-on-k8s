createPath = 'http://10.10.20.208:31112/function/create'; // Path to create API endpoint
listPath = 'http://10.10.20.208:31112/function/list'; // Path to list API endpoint
